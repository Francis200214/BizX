...
/**
 * 具体实现检查 Integer 最大值的处理器
 * <p>
 * 该类实现了 {@link CheckParameterStrategy} 接口，用于处理带有 {@link BizXCheckIntegerMax} 注解的参数。
 * </p>
 *
 * @see CheckParameterStrategy
 * @see BizXCheckIntegerMax
...
public class CheckParameterIntegerMaxHandler implements CheckParameterStrategy {
     ...
     * 获取当前处理器支持的注解类型
     *
     * @return 支持的注解类型 {@link BizXCheckIntegerMax}
     */
    @Override
